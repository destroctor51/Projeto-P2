...
public class AdicionarConta extends JPanel {
	...
	public AdicionarConta(final Permissao tipo, final JPanel telaAnterior) {
		...
		JLabel lblNewLabel_2 = new JLabel("Nome real:");
		...
		JLabel lblNewLabel_5 = new JLabel("Repita a senha:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				else if(gdc.cadastra(id, tipo, nome, email, new String(password)) == null) {
