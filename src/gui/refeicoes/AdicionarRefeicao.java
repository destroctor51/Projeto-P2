...
public class AdicionarRefeicao extends JPanel {
	...
	public AdicionarRefeicao(final JPanel telaAnterior,final String nomeRestaurante) {
		...
		JLabel lblAdR = new JLabel("Adicionando Refeicao no Restaurante ");
		lblAdR.setText("Adicionando Refei\u00E7\u00E3o no Restaurante <dynamic>");
		GridBagConstraints gbc_lblAdR = new GridBagConstraints();
		gbc_lblAdR.insets = new Insets(0, 0, 5, 0);
		gbc_lblAdR.gridx = 2;
		gbc_lblAdR.gridy = 0;
		panel_3.add(lblAdR, gbc_lblAdR);
		...
		gbl_panel_1.rowHeights = new int[]{39, 0, -48, 0};
		...
		gbc_lbObs.gridwidth = 2;
		gbc_lbObs.insets = new Insets(0, 0, 5, 5);
		gbc_lbObs.gridx = 1;
		gbc_lbObs.gridy = 0;
		...
		btnAdicionar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					lbObs.setText("Refei\u00E7\u00E3o adicionada com sucesso");
