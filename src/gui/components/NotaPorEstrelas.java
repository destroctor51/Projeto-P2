 ...
 *
 * @author noblemaster
 * Renomenado por Marianne Linhares Monteiro
 * @since August 30, 2010
 */
public class NotaPorEstrelas extends JPanel {
...
/** The listener. */
   ...
   */
  public NotaPorEstrelas(int stars) {
    this(stars, 0);
  }
   ...
   */
  public NotaPorEstrelas(int stars, float rating) {
    this(stars, rating, 0);
  }
   ...
   */
  public NotaPorEstrelas(int stars, float rating, int selection) {
    this.stars = stars;
    this.rating = rating;
    ...
    addMouseListener(new MouseAdapter() {
      ...
      /**
       * Modificado por Marianne Linhares Monteiro
       */
      public void mousePressed(MouseEvent event) {
        if (isEnabled()) {
          rollover = 0;
        //  done = true; Pra nao precisar sair do retangulo para selecionar outra nota!
          NotaPorEstrelas.this.selection = 1 + (event.getX() / STAR_BACKGROUND_IMAGE.getWidth(null));  
          for (int i = 0; i < listeners.size(); i++) {
            listeners.get(i).handleSelection(NotaPorEstrelas.this.selection);
          }
          repaint();
        }
      }
  ...
  private static final Image STAR_SELECTION_IMAGE = compressedByteArrayToImage(new byte[] {
    ...
    /**
     * Alterado por Marianne Linhares
     * @return em que estrela esta o cursor.
     */
	...
	/**
     * Alterado por Marianne Linhares
     * @return se estrela ja foi selecionada ou nao.
     */
